...
const proyects = [
  {
    ...
    imagen: image1,
    description:
      'Hemos alcanzado muchas firmas para poder presentar este proyecto. ¡Suma la tuya asi lo podamos cumplir!',
  },
  {
        ...
        <NewsHeaderCard
          ...
          title={
            <h5 className="heading-h5">
              Sistema de multas para los que arrojan basura en la calle
            </h5>
          }
