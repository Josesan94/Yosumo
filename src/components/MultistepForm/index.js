      ...
      <div className="form-container">
        <MultistepForm
          ...
          onSubmit={(values, actions) => {
            ...
            SuccessAlert(
              'Peticion creada!',
              "Podes a visualizar tu peticion en la pestaña 'mis peticiones'",
            );
            actions.resetForm();
          }}
        >
          <FormStep
            ...
            validationSchema={yup.object({
              title: yup
                ...
                .matches(/[A-Z]/, 'Debe comenzar con mayuscula'),
            })}
            className="title-container"
          >
            <InputField name="title" label="Titulo" />
          </FormStep>
          {({ formik } = {}) => (
            <FormStep
              stepName="Imagen"
          ...
          <FormStep
            ...
            validationSchema={yup.object({
              description: yup
                .string()
                .max(500)
                .required('Coloque una descripción'),
            })}
          ...
          <FormStep
            ...
            validationSchema={yup.object({
              ...
              email: yup
                .string()
                .email()
                .required('Debe colocar un mail valido'),
            })}
